...
curl -OL https://download.nvidia.com/XFree86/Linux-x86_64/$_nvidiaver/NVIDIA-Linux-x86_64-$_nvidiaver.run
...
[[ ! -f dlss-enabler-setup-2.90.800.0-b15.exe ]] || [[ ! -f NVIDIA-Linux-x86_64-$_nvidiaver.run ]] || [[ ! -f d3dcompiler_47.dll ]] || [[ ! -f innoextract-1.9-linux.tar.xz ]] && exit 2
...
mv app/* .
rm -r app
cp -f NVIDIA-Linux-x86_64-$_nvidiaver/nvngx.dll _nvngx.dll
cp -f NVIDIA-Linux-x86_64-$_nvidiaver/LICENSE LICENSE
chmod +r _nvngx.dll
rm -rf innoextract-1.9-linux NVIDIA-Linux-x86_64-$_nvidiaver innoextract-1.9-linux.tar.xz dlss-enabler-setup-2.90.800.0-b15.exe NVIDIA-Linux-x86_64-$_nvidiaver.run
